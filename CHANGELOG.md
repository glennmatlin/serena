...
* Language support:
  ...
  * **Add support for LaTeX** via texlab language server with automatic binary download. Supports document symbols, completion, references, definition, and formatting for .tex, .bib, .cls, and .sty files.
